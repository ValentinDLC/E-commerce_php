...
<section class="pt-[112px] md:pt-[140px] pb-32 bg-white min-h-screen">
  <div class="container-custom">
    ...
    <h1 class="text-4xl md:text-6xl font-extrabold text-ink tracking-tighter mb-16">MES FAVORIS</h1>
    ...
    <p id="wishlist-empty" class="hidden text-center text-ink/40 font-medium py-20">
      Aucun favori. <a href="{{ url('/collection') }}" class="text-crimson underline">Voir la collection</a>.
    </p>
  </div>
</section>
@endsection
