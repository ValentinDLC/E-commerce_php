...
@include('partials.breadcrumb', ['crumbs' => [['label' => 'Collection', 'url' => url('/collection')], ['label' => \$product['name']]]])
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
      ...
      <div>
        <p class="text-[0.7rem] font-cta font-extrabold uppercase tracking-[0.2em] text-crimson mb-3">{{ $product['num'] }} — Édition Région</p>
        ...
        <form id="add-to-cart-form"
          ...
          <p class="text-[0.7rem] font-cta font-extrabold uppercase tracking-[0.15em] text-ink mb-3">Taille</p>
          ...
          <p id="size-error" class="hidden text-crimson text-sm mb-6" role="alert">Choisis une taille.</p>

          <p class="text-[0.7rem] font-cta font-extrabold uppercase tracking-[0.15em] text-ink mb-3">Quantité</p>
          ...
          <div class="flex flex-col sm:flex-row gap-4">
            <button type="submit" class="btn-cta w-full sm:w-auto">Ajouter au panier</button>
    ...
    @if(count($related))
    <div class="mt-32">
      <h2 class="text-3xl md:text-4xl font-extrabold text-ink tracking-tighter mb-10">AUTRES RÉGIONS</h2>
