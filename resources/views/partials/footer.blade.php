<footer class="bg-gray-900 text-gray-400 py-14">
    <div class="container-custom">
        <div class="flex flex-col md:flex-row items-center justify-between gap-8 pb-8 border-b border-gray-800">
            <div class="text-center md:text-left">
                <span class="font-heading font-extrabold text-xl text-white">
                    DIMA<span class="text-crimson">DIMA</span>
                </span>
                <p data-i18n="footer_tagline" class="text-sm mt-2 max-w-xs">
                    One people, one heart, one homeland.
                </p>
            </div>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 text-sm">
            <p data-i18n="footer_rights">&copy; 2025 DIMA DIMA. All rights reserved.</p>
            <a href="mailto:hello@dimadima.ma" class="hover:text-white transition-colors">hello@dimadima.ma</a>
        </div>
    </div>
</footer>
